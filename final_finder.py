...
def generate_triliteral_candidates(word):
    ...
    # توليد كل التركيبات الثلاثية الممكنة
...
def main():
    ...
    for word in test:
        ...
        if root:
            entry = roots_index.get(root)
            meaning = entry.get("meanings","") if entry else ""
